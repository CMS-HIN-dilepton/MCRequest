...
# with command line options: 2013/Filter2013/python/Ups3SMM_5p02TeV_TuneCUETP8M1_cfi.py --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions STARTHI53_V27::All --beamspot Realistic5TeVPPbBoost --step GEN,SIM --no_exec -n 1000
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('2013/Filter2013/python/Ups3SMM_5p02TeV_TuneCUETP8M1_cfi.py nevts:1000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('Ups3SMM_5p02TeV_TuneCUETP8M1_cfi_py_GEN_SIM.root'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('Bottomonium:states(3S1) = 200553', 
